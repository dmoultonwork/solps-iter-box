...
input.dx = 1; % Poloidal length from X-point to target separatrix
...
input.ly = 1E20; %0.33; % Exponential radial compression width towards the separatrix
input.pfrfrac = 0.2; % Separatrix is positioned a distance pfrfrac*dy along the radial coordinate
...
input.pumplength = 0.1; % Length of the pumping surface, placed at the top right of the grid (m)
