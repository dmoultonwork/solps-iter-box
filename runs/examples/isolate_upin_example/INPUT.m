...
input.poloidal_section_number = 3; % From the leftmost end of the grid, this is the poloidal section to be isolated (e.g. for CDN, 1:lower inner leg, 3:upper inner leg, 4:upper outer leg, 6:lower outer).
...
input.wall_bl = [1.8,5.0];
input.wall_br = [1.4,5.2];
input.wall_tl = [1.4,4.8];
input.wall_tr = [1.2,5.0];
